...
const LABEL_LENGTH = 76; // largo visual del texto rotado
const LABEL_THICKNESS = 12; // alto de línea del texto (ancho real que ocupa)
...
const styles = StyleSheet.create({
  ...
  label: {
    color: colors.white, fontSize: 8, lineHeight: LABEL_THICKNESS, ...fonts.bold,
    letterSpacing: 0.5,
