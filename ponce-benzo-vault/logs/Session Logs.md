...
| :--- | :--- | :--- | :--- |
| 2026-06-08 | [[logs/Log-2026-06-08\|Log-2026-06-08 (Task 1 Ingesta — Helpers TDD)]] | Pipeline de ingesta: Task 1 completada con TDD estricto. Creados `tools/ingesta/helpers.ts` y `helpers.test.ts`. 4 funciones puras (`channelForStore`, `cleanStoreName`, `storeKey`, `referenceWeekDates`) — 4/4 tests pasan. Commit `13b6fbf` en rama `feature/ingesta-datos`. | Completado |
