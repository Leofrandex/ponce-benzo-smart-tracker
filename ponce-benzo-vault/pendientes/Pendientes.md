...
1. ✅ **Cambio A — filtros en Tareas** implementado en la rama `feat/tareas-filtros-vendedor` (ver [[logs/Log-2026-09-07|Log]]). **Desplegado en producción** (Vercel READY, commit `4770d77`). **Pendiente:** comprobar con un vendedor real que el selector solo lo muestra a él.
