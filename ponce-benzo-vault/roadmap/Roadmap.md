...
- [/] **Sincronización Móvil:** ✅ *login + rutas hecho (2026-06-08)* — cliente Supabase (AsyncStorage), login real con sesión persistida, carga de la ruta del día con fallback. Verificado E2E con JWT. Ver [[arquitectura/Spec - Mobile Login y Rutas|Spec]] y [[logs/Log-2026-06-08-mobile-login|Log]]. **Falta el motor de sync** (cola SQLite→Supabase: visits/pings/competencia), subida de fotos a Storage, GPS cada 30s y cacheo offline — sub-proyecto Mobile 2.
