...
- [x] **Filtros en Tareas (2026-09-07):** vendedor (vía `client_assignments`), cliente, tipo y buscador combinables, más enlace directo `/panel/tareas?task=<id>` para los correos. En rama, pendiente de merge/deploy. Ver [[logs/Log-2026-09-07|Log 2026-09-07]].
